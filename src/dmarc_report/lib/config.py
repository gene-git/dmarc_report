...
def _read_configs_v1(fpath) -> dict:
    """
...
def _convert_v1_v2(dmarc, tls):
    ...
    #        if key in dmarc and val = dmarc.get(key):
    #            keys_shared.append(key)
    #            glob[key] = val
...
def _save_config_v2(config, fpath) -> bool:
    '''
