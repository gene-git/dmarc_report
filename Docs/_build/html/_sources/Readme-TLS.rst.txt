...
These reports are used for a email domain with support for either DANE or MTA-STS or both.
...
*tls-rpt* is provided as part of the dmarc_report package
...
while DANE is documented in [RFC 6698] [3]_, [RFC 7671] [4]_ and [RFC 7672] [5]_ ::
...
Using the --dir option (or setging the config option *dir*) makes unnecessary to change directories before
running the report.
